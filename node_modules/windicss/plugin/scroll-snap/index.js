...
var index = createPlugin(function (_a) {
    ...
    ['margin', 'padding'].forEach(function (name) {
        var n = name.charAt(0);
        var tn = dashToCamel("snap-" + name);
        addDynamic("snap-" + n, function (_a) {
            ...
            if (directions) {
                if (directions[0] === '*')
                    return Property("scroll-" + name, value);
                return Property(directions.map(function (i) { return "scroll-" + name + "-" + i; }), value);
            }
        }, {
            ...
            completions: __spreadArray([], ['{static}', '{float}', '{size}', '${var}', '[7px]']
                ...
                .map(function (i) { return "snap-" + n + i + "-" + type; }); })

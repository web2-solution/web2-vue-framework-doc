...
function animation(utility, _a) {
    ...
    if (animateIterationCount)
        return new Property(['-webkit-animation-iteration-count', 'aniamtion-iteration-count'], animateIterationCount).updateMeta('utilities', 'animation', pluginOrder.animation, 23, true);
...
var Processor = /** @class */ (function () {
    ...
    Processor.prototype.loadShortcuts = function (shortcuts) {
        ...
        var _loop_3 = function (key, value) {
            ...
            if (typeof value === 'string') {
                this_1._plugin.shortcuts[key] = this_1.compile(value, undefined, undefined, false, undefined, cssEscape(prefix + key)).styleSheet.children.map(function (i) { return i.updateMeta('components', 'shortcuts', layerOrder['shortcuts']); });
            }
            else {
                var styles_1 = [];
                ...
                this_1._plugin.shortcuts[key] = styles_1.map(function (i) { return i.updateMeta('components', 'shortcuts', layerOrder['shortcuts']); });
            }
        };
        var this_1 = this;
    ...
    Processor.prototype.addUtilities = function (utilities, options) {
        ...
        var _loop_4 = function (key, value) {
            ...
            if (options.layer)
                styles.forEach(function (style) { return style.updateMeta(layer, 'plugin', order); });
        ...
        this._plugin.dynamic[key] = (key in this._plugin.dynamic)
            ...
            : function (Utility) {
                ...
                if (Array.isArray(output))
                    return output.map(function (i) { return i.updateMeta(layer, group, order, 0, false, i.meta.respectSelector || uOptions.respectSelector); });
    ...
    Processor.prototype.addBase = function (baseStyles) {
        ...
        for (var _i = 0, _a = Object.entries(baseStyles); _i < _a.length; _i++) {
            var _b = _a[_i], key = _b[0], value = _b[1];
            var styles = Style.generate(key, value).map(function (i) { return i.updateMeta('base', 'plugin', 10); });

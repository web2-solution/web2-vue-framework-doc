...
declare function createUtils(userOptions?: UserOptions | ResolvedOptions, utilsOptions?: WindiPluginUtilsOptions): {
    ...
    extractFile: (code: string, id?: string | undefined, applyTransform?: boolean) => Promise<boolean>;
    ...
    transformCSS: (css: string, id: string, transformOptions?: {
        ...
        globaliseKeyframes?: boolean | undefined;
    } | undefined) => string;
    transformGroups: typeof transformGroups;
    readonly transformAlias: (code: string, sourcemap?: boolean) => {
        code: string;
        map: magic_string.SourceMap | undefined;
    } | null;
